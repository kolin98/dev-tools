...
7. **Add co-authored-by tags to commit messages** - When creating git commits, include `Co-Authored-By: Claude Code <noreply@anthropic.com>` trailers to attribute AI assistants in the commit message. 
